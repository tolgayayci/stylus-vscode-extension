...
function exportAbiHandler(projectDataProvider, directProject) {
    (0, checkCargoStylus_1.checkCargoStylus)()
        .then(() => {
        selectProjectFolderAndExecuteExportAbi(projectDataProvider, directProject);
    })
        .catch((err) => {
...
function selectProjectFolderAndExecuteExportAbi(projectDataProvider, directProject) {
    if (directProject) {
